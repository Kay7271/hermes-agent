...
def resolve_provider(
    ...
    *,
    ...
    _PROVIDER_ALIASES = {
        ...
        "acp": "generic-acp", "generic-acp-agent": "generic-acp",
...
def resolve_external_process_provider_credentials(provider_id: str) -> Dict[str, Any]:
    ...
    if provider_id == "generic-acp":
        ...
        if not resolved_command and not base_url.startswith("acp+tcp://"):
            raise AuthError(
                f"Could not find the ACP command '{command}'. "
                "Set HERMES_ACP_COMMAND to the path of your ACP-compatible CLI.",
                provider=provider_id,
